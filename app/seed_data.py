...
from app.infrastructure.database.models import User as UserModel, Patient as PatientModel, Encounter as EncounterModel, Observation as ObservationModel
    ...
    try:
        ...
        encounters_data = [
            ...
            },
            {
                ...
                "period_start": datetime(2024, 1, 16, 14, 0),
                "period_end": None,
                "reason_code": "Z00.00",
                "resource": {
                    "resourceType": "Encounter",
        ...
        observations_data = [
            {
                ...
                "effective_datetime": datetime(2024, 1, 15, 9, 30),
            ...
            },
            {
                ...
                "subject_patient_id": created_patients[0].id,
                "encounter_id": created_encounters[0].id,
                "effective_datetime": datetime(2024, 1, 15, 9, 35),
            ...
            },
            {
                ...
                "effective_datetime": datetime(2024, 1, 16, 14, 15),
